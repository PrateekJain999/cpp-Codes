...
class queue
{
	...
	switch (ch)
	{
		case 1:
			system("CLS");
			display_by_flight("PKR-108");
			break;
		case 2:
			system("CLS");
			display_by_flight("PKR-320");
			break;
		case 3:
			system("CLS");
			display_by_flight("PKR-170");
			break;
		case 4:
			system("CLS");
			display_by_flight("PKR-102");
			break;
		case 5:
			system("CLS");
			display_by_flight("PKR-101");
			break;
		default:
			system("CLS");	
	...
	void flights_info()
	{
		...
		gotoxy(4,6);
		cout<<left<<setw(6)<<"1"<<setw(15)<<"PKR-108"<<setw(14)<<"Karachi"<<setw(17)<<"Lahore"<<setw(14)<<"11:00 PM"<<"100$";
		gotoxy(4,8);
		cout<<left<<setw(6)<<"2"<<setw(15)<<"PKR-320"<<setw(14)<<"Lahore"<<setw(17)<<"AbuDhabi"<<setw(14)<<"12:00 PM"<<"250$";
		gotoxy(4,10);
		cout<<left<<setw(6)<<"3"<<setw(15)<<"PKR-170"<<setw(14)<<"Islamabad"<<setw(17)<<"Lahore"<<setw(14)<<"03:00 PM"<<"100$";
		gotoxy(4,12);
		cout<<left<<setw(6)<<"4"<<setw(15)<<"PKR-102"<<setw(14)<<"Sialkot"<<setw(17)<<"Paris"<<setw(14)<<"02:00 AM"<<"500$";
		gotoxy(4,14);
		cout<<left<<setw(6)<<"5"<<setw(15)<<"PKR-101"<<setw(14)<<"Lahore"<<setw(17)<<"Karachi"<<setw(14)<<"09:00 AM"<<"100$";	
	}
	void Menu()
	{
		gotoxy(2,2);	
